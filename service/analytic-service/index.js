...
const run = async () => {
    try {
        ...
        await consumer.subscribe({
            topics: ['payment-successful', "order-successful", "email-successful"],  // Subscribe to all relevant topics
            fromBeginning: true
        });
            ...
            eachMessage: async ({ topic, partition, message }) => {
                ...
                switch (topic) {
                    ...
                    case "email-successful": {
                        ...
                        console.log(`Analytic consumer:Email id ${emailId} created for user id ${userId}`)
                    };
                        break;
                    default:
                        break;
